...
<div class="header">
  <div class="header-box">
    <h1 class="logo">网站后台管理系统</h1>
    <ul id="nav" class="nav"></ul>
    <div class="nav-right">
        <div class="dateTime"><%=System.DateTime.Now.Year+"年"+System.DateTime.Now.Month+"月"+System.DateTime.Now.Day+"日"+System.DateTime.Now.DayOfWeek %></div>
      <div class="icon-info">
        <span>
