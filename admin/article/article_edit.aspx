...
<script type="text/javascript">
    $(function () {
        ...
        $(".upload-img").each(function () {
            $(this).InitSWFUpload({ sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf" ,filesize:"20480"});
        });
        $(".upload-album").each(function () {
            $(this).InitSWFUpload({ btntext: "批量上传", btnwidth: 66, single: false, water: true, thumbnail: true, filesize: "10240", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;" });
        });
          ...
          <asp:Repeater ID="rptAttachList" runat="server">
            <ItemTemplate>
              <li>
                ...
                <input name="txt_attach_point" type="hidden" value="<%#Eval("point")%>" />
                <i class="icon"></i>
                ...
                <div class="btns">附件地址：<a href="#" title="<%#Eval("file_path")%>" onclick="window.clipboardData.setData('Text', this.title);alert('复制成功')">点击复制</a></div>
                  <%--<input type="text" name="txt_attach_point" onkeydown="return checkNumber(event);" value="<%#Eval("point")%>" />--%>
              </li>
            </ItemTemplate>
          </asp:Repeater>
        </ul>
