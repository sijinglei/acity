...
<script type="text/javascript">
    ...
    //页面加载完成执行
    $(function () {
        $(".upload-attach").InitSWFUpload({ filesize: "20480", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf", filetypes: "*.jpg;*.jpge;*.png;*.gif;*.rar;*.zip;*.doc;*.xls;*.xml;*.pdf;" });
    ...
    function appendAttachHtml(fileName, filePath, fileExt, fileSize, fileSizeStr) {
        if ($(api.data).length > 0) {
            ...
            + '<input name="txt_attach_point" type="hidden" value="0" />'
            + '<i class="icon"></i>'
            ...
            + ' <div class="btns">附件地址：<a href="#" title="' + filePath + '">保存后可以复制附件链接</a></div>'     
