...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" title=\"查看美食\" rel=\"category tag\">美食</a></div>\r\n    <!-- 面包屑end --> \r\n  </div>\r\n</div>  \r\n\r\n<div class=\"container wrapper\">\r\n  <div class=\"wrap\">\r\n    <div class=\"content-wrap left\">\r\n      <div class=\"content\" id=\"main\">\r\n        <ul id=\"foods\">\r\n        ");
	DataTable goods_list = get_article_list("goods", 0, 40, "status=0 and is_red=1");
	...
	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\"></a><p>" + Utils.ObjectToStr(dr["title"]) + "</p></li>\r\n            ");
	}	//end for if
	...
	templateBuilder.Append("\r\n            <li><a href=\"");
	templateBuilder.Append(linkurl("goods_show",Utils.ObjectToStr(cdr1["id"])));
