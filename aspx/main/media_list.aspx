...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(category_id,"影音娱乐");
	...
	templateBuilder.Append("\" title=\"查看影音娱乐\" rel=\"category tag\">影音娱乐</a>-");
	...
	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">\r\n                      <img width=\"550\" height=\"367\" src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" class=\"attachment-full wp-post-image\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\"></a>\r\n                  </div></div>\r\n               ");
	...
	templateBuilder.Append("\r\n        <link rel=\"stylesheet\" href=\"");
	templateBuilder.Append("/templates/acity");
	templateBuilder.Append("/css/magnific-popup.css\" type=\"text/css\">\r\n  <script src=\"");
	templateBuilder.Append("/templates/acity");
	templateBuilder.Append("/js/jquery.imagesloaded.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n  <script src=\"");
	templateBuilder.Append("/templates/acity");
	templateBuilder.Append("/js/jquery.magnific-popup.min.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n  <script src=\"");
	templateBuilder.Append("/templates/acity");
	templateBuilder.Append("/js/jquery.wookmark.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n            <div id=\"gifMain\" role=\"main\">\r\n              <ul id=\"tiles\">\r\n                  ");
	foreach(DataRow dr in photo_list.Rows)
	{

	string img_h = get_article_field(Utils.StrToInt(Utils.ObjectToStr(dr["id"]), 0),"img_h" );

	templateBuilder.Append("\r\n                   <li>\r\n                  <a href=\"" + Utils.ObjectToStr(dr["img_url"]) + "\">\r\n                    <img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" width=\"236\" height=\"");
	templateBuilder.Append(Utils.ObjectToStr(img_h));
	templateBuilder.Append("\">\r\n                  </a>\r\n                  <p><a href=\"");
	templateBuilder.Append(linkurl("photo_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\" target=\"_blank\">" + Utils.ObjectToStr(dr["title"]) + "</a></p>\r\n                </li>\r\n              ");
	}	//end for if
