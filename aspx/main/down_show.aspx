...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(linkurl("down_list",model.category_id));
	...
	templateBuilder.Append("\" rel=\"bookmark\" target=\"_blank\" title=\"详细阅读 ");
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	templateBuilder.Append("  \">\r\n          ");
	templateBuilder.Append(Utils.ObjectToStr(model.title));
	...
	templateBuilder.Append("\r\n          <li><span><a class=\"read-more\" href=\"javascript:;\" onclick=\"downLink(");
	...
	templateBuilder.Append("\r\n          <div class=\"clearfix\"></div>\r\n          <div class=\"pre-next\">\r\n        <div class=\"left\">\r\n          上一篇：：");
	templateBuilder.Append(get_prevandnext_article("down_show", -1, "亲，已经是第一篇了！", 0).ToString());

	templateBuilder.Append("\r\n        </div>\r\n        <div class=\"right\">\r\n          下一篇：：");
	templateBuilder.Append(get_prevandnext_article("down_show", 1, "亲，已经是最后一篇了！", 0).ToString());

	templateBuilder.Append("</div>\r\n      </div>\r\n          <!--推荐文章-->\r\n          <div class=\"same_cat_posts\">\r\n    <h3><a href=\"http://www.yizuocity.com\" title=\"一座城池博客\"></a> 推荐下载：</h3>\r\n  <ul class=\"same_cat_posts_ul\">\r\n       ");
	DataTable rednews1 = get_article_list("down", model.category_id, 6, "is_red=1 and id<>"+model.id);
	...
	templateBuilder.Append("\" target=\"_blank\" title=\"点击下载 " + Utils.ObjectToStr(dr["title"]) + "\">" + Utils.ObjectToStr(dr["title"]) + "</a></h2>\r\n      </div>\r\n    </li>\r\n      ");
	}	//end for if
	...
	templateBuilder.Append("\" title=\"点击下载 " + Utils.ObjectToStr(dr2["title"]) + "\">" + Utils.ObjectToStr(dr2["title"]) + "</a></li>\r\n          ");
	}	//end for if
