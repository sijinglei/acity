...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(model.category_id,"美食");
	...
	templateBuilder.Append("\r\n          \r\n          <div class=\"clearfix\"></div>\r\n          <div class=\"pre-next\">\r\n        <div class=\"left\">\r\n          上一篇：：");
	templateBuilder.Append(get_prevandnext_article("news_show", -1, "亲，已经是第一篇了！", 0).ToString());

	templateBuilder.Append("\r\n        </div>\r\n        <div class=\"right\">\r\n          下一篇：：");
	templateBuilder.Append(get_prevandnext_article("news_show", 1, "亲，已经是最后一篇了！", 0).ToString());

	templateBuilder.Append("</div>\r\n      </div>\r\n          <!--推荐文章-->\r\n          <div class=\"same_cat_posts\">\r\n    <h3><a href=\"http://www.yizuocity.com\" title=\"一座城池博客\"></a> 推荐阅读：</h3>\r\n  <ul class=\"same_cat_posts_ul\">\r\n       ");
	DataTable rednews1 = get_article_list("news", model.category_id, 6, "is_red=1 and id<>"+model.id);
	...
	DataTable redfoods = get_article_list("goods", 0, 6, "is_red=1 and img_url<>''");
